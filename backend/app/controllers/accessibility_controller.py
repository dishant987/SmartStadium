...
async def accessibility_status(service: AccessibilityService = Depends()):
    return await service.get_status()


@router.post("/ai-route", response_model=AccessibilityRouteResponse)
async def ai_route(body: AccessibilityRouteRequest, service: AccessibilityService = Depends()):
